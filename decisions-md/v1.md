...
This style is project-agnostic — you can copy this file verbatim into any repository to establish a consistent decision-recording convention. See the [Apathetic Decisions.md Style](https://apathetic-recipes.github.io/decisions-md) for more details.
...
*Format inspired by [Apathetic Decisions Style v1](https://apathetic-recipes.github.io/decisions-md) and [ADR](https://adr.github.io/), optimized for small, evolving projects.*
